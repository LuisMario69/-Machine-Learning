...
# Generar boxplots para cada una de las características del conjunto de datos (Identificación de valores atípicos )
...
# Histograma de las características numéricas (Visualización de la distribución de los datos (Histogramas) )
...
# Pairplot para ver la relación entre las características numéricas (Relación entre las características (Gráficas de dispersión))
